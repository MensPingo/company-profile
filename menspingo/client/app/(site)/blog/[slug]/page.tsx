        ...
        <Stack spacing={{ xs: 2.5, md: 3 }}>
          <Card
            ...
            sx={{
              ...
              boxShadow: "0 14px 38px rgba(15, 23, 42, 0.08), inset 0 1px 0 rgba(255,255,255,0.9)",
              "&::before": {
                content: '""',
                position: "absolute",
                inset: "0 0 auto 0",
            ...
            <CardContent sx={{ p: { xs: 2.5, sm: 3.5, md: 4.5 } }}>
              ...
              >
                <Stack direction="row" spacing={1} alignItems="center">
                  ...
                  <Typography variant="caption" sx={{ fontWeight: 850, letterSpacing: 0.3, color: "#64748b" }}>
              ...
              >
                <Stack direction="row" spacing={1.25} alignItems="center">
                  ...
                  <Typography sx={{ fontWeight: 950, letterSpacing: -0.2, color: "#0f172a" }}>Summary</Typography>
                </Stack>

                <Typography sx={{ mt: 1.25, color: "#475569", lineHeight: 1.8, fontSize: { xs: "0.98rem", md: "1.04rem" } }}>
                  {post.summary}
                </Typography>
              </Box>
              ...
              <Typography sx={{ fontWeight: 950, letterSpacing: -0.25, fontSize: { xs: "1.25rem", md: "1.45rem" }, color: "#0f172a" }}>
                Article
              </Typography>

              <Box sx={{ mt: 2, p: { xs: 2, md: 2.5 }, borderRadius: 4, border: "1px dashed rgba(37, 99, 235, 0.35)", bgcolor: "#f8fbff" }}>
